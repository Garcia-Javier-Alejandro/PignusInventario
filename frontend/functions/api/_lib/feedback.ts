...
function buildReceivedHtml({ type, screen }: { type: string; screen: string | null }) {
...
feedback.post('/', async (c) => {
  ...
  await sendEmail(c.env.RESEND_API_KEY, {
    ...
    html: buildReceivedHtml({ type, screen: screen ?? null }),
  })
